// from https://github.com/structurizr/examples/blob/main/dsl/microservices/workspace.dsl
workspace {
    ...
    views {
        ...
        container softwareSystem "Containers_Service1" {
            include ->software_system.service1->
            autolayout
        }

        container softwareSystem "Containers_Service2" {
            include ->software_system.service2->
            autolayout
        }

        container softwareSystem "Containers_Service3" {
            include ->software_system.service3->
            autolayout
        }
